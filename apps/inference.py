...
def inference():
    ...
    image_data =Image(name="image", uID="323332", mimeType="image/jpg", encoding="base64",value =image.encode64(np.asarray(cv2.imread(config.project.path +'/capsules/capsule/resources/yorkshire_terrier.jpg')).astype(np.float32),'image/jpg'), type="imageList", field="img")
    ...
    imageList = Images(name="Images", value=[image_data], type="Images")
