...
from capsules.capsule.src.models.PackageModel import SegmentationExecutor,PackageModel,PackageConfigs,SegmentationResponse,SegmentationOutputs,ImageData,OutputData,ConfigExecutor
...
class Segmentation(Capsule):
    ...
    def run(self):
            ...
            imageList = ImageData(name="Imagedata", value=pred_list)
